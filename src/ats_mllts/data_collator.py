...
class DataCollatorForSeq2Seq:
    ...
    split_keys = ["token_mask", "pos", "inarc", "depth_d", "head", "root_head_mask",
    ...
    def __call__(self, batch, return_tensors=None):
        ...
        if self.include_features:
            ...
            id_inputs, _, _ = self._split_dict(inputs, self.split_keys)
        ...
        if labels is not None:
            if self.include_features:
                ...
                id_labels, _, _ = self._split_dict(labels, self.split_keys)
