...
### Note: all following running script examples should be one line without backslash. Multiple lined examples here are for readability.
...
#### Annotate dataset
    ...
    Note: 
        ...
        2. to annotate test set, just replace validation with test.
